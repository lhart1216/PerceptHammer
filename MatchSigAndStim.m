function [sig, t_td, fs_td, stim, t_fd, fs_fd, perSpec] = MatchSigAndStim(bsTD, bsFD)
...
iSampInc = cell2mat(indPerExpPack(tdTicksAdjI));
...
%     t_fdOLD = (1:length(stim.L))'/fs_fd + (fdTicks(1)-tdTicks(1))/1000;
